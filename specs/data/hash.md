...
the hash output is 32 bytes (4 field elements). this is the `particle` — the content-derived identity of data, the name of a file in the cybergraph: what a cyberlink holds.
