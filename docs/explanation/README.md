...
| completeness.md | why exactly these instruction groups — structural, field, bitwise, hash, call, look |
...
| hint.md | call (hint) — the boundary of knowledge — one instruction that provides privacy, search, and oracles |
